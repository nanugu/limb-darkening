...
GRID_CHOICES = ["stagger", "kurucz", "mps1", "mps2", "all"]
...
def _fit_target(
    ...
    *,
    ...
    return {
        ...
        "input_coeff_source": f"exotic_ld_{grid}_{law}_fit_to_Imu",
        "grid_model": grid,
        "law_model": law,
...
def main() -> None:
    args = _parse_args()
    grids = ["stagger", "kurucz", "mps1", "mps2"] if args.grid == "all" else [args.grid]
    for grid in grids:
